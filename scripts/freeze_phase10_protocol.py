...
OUTPUT_PATH = Path("phase10_results/frozen_prompt_manifest.json")
PROTOCOL_PATH = Path("PHASE10_INTERFACE_CAPACITY_PROTOCOL.md")
...
def main() -> None:
    ...
    payload = {
        "status": "phase10_protocol_frozen_before_confirmation",
    ...
    if payload["unique_prompts"] != 300:
        raise AssertionError("Phase 10 confirmation must contain 300 unique prompts")
